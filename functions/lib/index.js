...
exports.sendBroadcastNotification = exports.sendManualReminder = exports.finalReminder = exports.morningReminder = void 0;
...
async function sendAttendanceReminders(title, body) {
    ...
    try {
        ...
        for (const [uid, user] of Object.entries(users)) {
            if (user && typeof user === "object" && user.role === "employee" && user.fcmToken) {
                const u = user;
                u.uid = uid;
